...
It can also be called at http://54.203.198.53:7001 via Artur's prototype dApp, in this case fill only content and style image fields with either a path to local image (see examples in the repository) or the url of a jpg/png image. It is registered under SNET/StyleTransfer.
